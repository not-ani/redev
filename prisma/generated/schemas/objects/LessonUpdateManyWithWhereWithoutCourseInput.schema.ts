...
const Schema: z.ZodType<Prisma.LessonUpdateManyWithWhereWithoutCourseInput> = z
  .object({
...
export const LessonUpdateManyWithWhereWithoutCourseInputObjectSchema = Schema;
